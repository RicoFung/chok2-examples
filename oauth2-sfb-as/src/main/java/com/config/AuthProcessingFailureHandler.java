...
public class AuthProcessingFailureHandler extends SimpleUrlAuthenticationFailureHandler
{
	...
	public AuthProcessingFailureHandler(MessageSource messageSource, LocaleResolver localeResolver)
	{
