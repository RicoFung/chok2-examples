...
//		cookieCsrfTokenRepository.setCookieWriter(new HttpOnlyCsrfCookieWriter() {
//			@Override
//			public void writeCookie(HttpServletRequest request,
//									HttpServletResponse response,
//									String token) {
//				super.writeCookie(request, response, token);
//				response.addHeader("Set-Cookie", String.format(
//						"%s=%s; Path=%s; Secure; HttpOnly; SameSite=None",
//						csrfTokenRepository.getCookieName(),
//						token,
//						csrfTokenRepository.getCookiePath()));
//			}
//		});
	...
	private AuthenticationEntryPoint authenticationEntryPoint() {
		AuthenticationEntryPoint authenticationEntryPoint =
				new LoginUrlAuthenticationEntryPoint("/oauth2/authorization/rico-client-oidc");
